...
st.set_page_config(page_title="Chronic Disease Prediction", layout="centered", page_icon="💉")

# Define paths and load models
working_dir = os.path.dirname(os.path.abspath(__file__))

try:
    diabetes_model = pickle.load(open(r'D:\Nishant\Chronic_Disease_Pred\diabetes.pkl', 'rb'))
    heart_disease_model = pickle.load(open(r'D:\Nishant\Chronic_Disease_Pred\heart.pkl', 'rb'))
    kidney_disease_model = pickle.load(open(r'D:\Nishant\Chronic_Disease_Pred\kidney.pkl', 'rb'))
...
# Dynamic header
st.markdown(f"<h1 class='title'>👨‍⚕️ Welcome to Chronic Disease Prediction System</h1>", unsafe_allow_html=True)
